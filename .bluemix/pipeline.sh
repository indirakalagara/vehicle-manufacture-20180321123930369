...
export IBP_NAME="ibm-blockchain-5-prod"  #"ibm-blockchain-5-staging"
export IBP_PLAN="ibm-blockchain-plan-v1-starter-prod" #"ibm-blockchain-plan-v1-starter-staging"
